...
Ids_Dev = {Id_Dev,1614314857,1398830949,1717439120,}
User_Bot = sudos.User_bot
Name_Bot = (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "فولت")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
CmdStart = '\n🎗╿ اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "فولت")..''..
...
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1717439120) then  
...
if tonumber(result.id_) == tonumber(1717439120) then  
send(msg.chat_id_, msg.id_, "🎗╿لا تسطيع حظر مبرمج السورس\n✓")
return false 
end
...
if text == 'سورس فولت' or text == 'حرنكش' or text == 'تيست الكودد' then
local Text = [[
test
]]
keyboard = {} 
...
{
{text = '🚫╿بوت الحذف', url = "https://t.me/LC6BOT"}
},
{
{text = 'اضف البوت لمجموعتك☑️', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
if text == (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "فولت") then
Namebot = (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "فولت")
local namebot = {
"يا روح "..Namebot.. " قول",
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '- •🅲︎🅷︎🅰︎🅽︎🅽︎🅴︎🅻︎• .',url="t.me/Source_Queen"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'العاب فولت' or text == 'الالعاب فولت' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس فولت 🎮
...
if text == 'الالعاب' or text == 'الالعاب' or text == 'الالعاب فولت' or text == '"' then
local Text =[[
للالعاب الاحترافيه
اكتب ← الالعاب فولت
•━═━═━═━═━═━═━═━═━•
...
•━═━═━═━═━═━═━═━═━•
ᴄʜᴀɴᴇʟ ➳ [ sᴏᴜʀᴄᴇ ᴠᴏʟᴛ](https://t.me/AKJA0)
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '💠╿𝗖𝗵𝗮𝗻𝗻𝗲𝗹 𝗕𝗼𝗹𝘁', url = "https://t.me/Source_Queen"},
},
{
{text = 'اضف البوت لمجموعتك☑️', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
if text == 'يا بوت' or text == 'بوت' or text == 'بوت فولت' then
local Text = [[
...
{
{text = '𝐀𝐡𝐦𝐞𝐝', url = "https://t.me/Dev_Ah8"},{text = '𝐓𝐢𝐠𝐞𝐫', url = "https://t.me/Dev_RE9"},
},
{
{text = '𝐊𝐠𝐭 𝐉𝐚𝐯𝐚', url = "https://t.me/UU_AK"}
},
{
{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐕𝐨𝐥𝐭', url = "https://t.me/AKJA0"}
},
{
{text = 'اضف البوت لمجموعتك☑️', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
if text == 'الاوامر' or text == 'الاوامر فولت' or text == 'الأوامر' then
if Admin(msg) then
local Text =[[
...
{
{text = '•🅲︎🅷︎🅰︎🅽︎🅽︎🅴︎🅻︎•', url = "https://t.me/Source_Queen"}
},
{
{text = 'اضف البوت لمجموعتك☑️', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
