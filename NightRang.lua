...
if text == 'جافا' or text == 'عمرو' or text == 'مبرمج السورس' or text == 'فلسطس اتثتلهكر' or text == 'خسخسخس' then
local Text =[[
☑️╿ مبرمج السورس
]]
keyboard = {} 
...
{
{text = '𝗔𝗺𝗿 𝗝𝗮𝘃𝗮', url = "https://t.me/UU_AK0"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'احمد' or text == 'المصري' or text == 'مصري' or text == 'توام اتتتلعالمي' or text == 'روح العتتالمي' then
local Text =[[
💠╿ مبرمج السورس
]]
keyboard = {} 
...
{
{text = '•𝙲𝚑𝚊𝚗𝚗𝚎𝚕 𝚅𝚘𝚕𝚝•', url = "https://t.me/AKJA0"}
},
{
{text = 'اضف البوت لمجموعتك☑️', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
