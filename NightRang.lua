...
https.request('http://devstorm.ml/NightRang/tahaj200.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
...
local TEXT_SUD = redis:get(bot_id..'NightRang:TEXT_SUDO')
if TEXT_SUDO then 
