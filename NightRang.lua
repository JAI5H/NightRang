...
if text == '/start' then   
if not redis:get(NighRang..'Start:Time'..msg.sender_user_id_) then
local inline = {{{text="المطور",url="t.me/"..(UserName_Dev or "Source_Queen")}}}
...
local start = redis:get(NighRang.."Start:Bot")
if start then 
GetCmdStart = start
else
GetCmdStart = "⚘مرحبا انا بوت اسمي { "..name_bot.." }\n⚘اختصاصي حماية المجموعات\n⚘من التفليش والسبام والخخ .. . ،\n⚘قم برفعي ادمن في مجموعتك وارسل ( تفعيل )\n⚘سيتم رفع الادمنيه والمنشئ تلقائيا"
end
send_inline(msg.chat_id_,GetCmdStart,nil,inline)
send_inline(msg.chat_id_,Sudo_Welcome,key)
end
redis:setex(NighRang..'Start:Time'..msg.sender_user_id_,300,true)
return false
end end
