...
Name_Bot = (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "جولد")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
elseif redis:sismember(bot_id.."NightRang:Developer:Bot1", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "المطور الاساسي"  
elseif redis:sismember(bot_id.."NightRang:Developer:Bot", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "المطور"  
elseif redis:sismember(bot_id.."NightRang:President:Group"..chat_id, user_id) then
Status = redis:get(bot_id.."NightRang:President:Group:Reply"..chat_id) or "المنشئ الاساسي"
elseif redis:sismember(bot_id..'NightRang:Constructor:Group'..chat_id, user_id) then
...
Status = redis:get(bot_id.."NightRang:Mempar:Group:Reply"..chat_id) or "عضو"
end  
return Status
end 
------------------------------------------------------------------------------------------------------------
...
CmdStart = '\n🎗╿ اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "جولد")..''..
...
if text == 'سورس جولد' or text == 'حرنكش' or text == 'تيست الكودد' then
local Text = [[
test
]]
keyboard = {} 
...
if text == "اسم البوت" and Dev_Bots(msg) or text == "تغيير اسم البوت" and Dev_Bots(msg) then
if "x" == "c"  then
send(msg.chat_id_, msg.id_,'🎗╿ عليك الاشتراك بقناة السورس \n 🎗╿ قناة السورس - [@AKJA0] ') 
return false
end 
...
if text == 'جافا' or text == 'عمرو' or text == 'مبرمج السورس' or text == 'توام اتتتلعالمي' or text == 'روح العتتالمي' then
local Text =[[
☑️╿ مبرمج السورس
]]
keyboard = {} 
...
{
{text = '𝗔𝗺𝗿 𝗝𝗮𝘃𝗮', url = "https://t.me/UU_AK"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'قناه سورس جولد' or text == 'قناه السورس' or text == 'قناة السورس' or text == 'توام اتتتلعالمي' or text == 'روح العتتالمي' then
local Text =[[
☑️╿ اضغط على الزر بالاسفل للدخول الي قناه السورس
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '🄲🄷🄰🄽🄽🄴🄻', url = "https://t.me/AKJA0"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Java98_bot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'رامي' or text == 'تايجر' or text == 'تايجر التلي' or text == 'تبت' or text == 'قلب تتتلعالمي' then
local Text =[[
مطور السورس ✅
]]
keyboard = {} 
...
{
{text = '𝗗𝗲𝘃 𝗧𝗶𝗴𝗲𝗿', url = "https://t.me/Dev_RE9"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "جولد") then
Namebot = (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "جولد")
local namebot = {
"يا روح "..Namebot.. " قول",
...
if text == 'الاوامر' or text == 'الاوامر جولد' or text == 'الأوامر' then
if Admin(msg) then
local Text =[[
...
{
{text = 'قناه سورس جولد ↗️', url = "https://t.me/AKJA0"}
},
{
{text = 'اضف البوت لمجموعتك☑️', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
