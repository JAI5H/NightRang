...
Ids_Dev = {Id_Dev,1756511631,1174250096}
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or '●○━━━━━𝑄𝑁━━━━━○●'
local text2 = redis:get(bot_id..'NightRang:new:sourse2') or '◍'
text = string.gsub(text,"●○━━━━━𝑄𝑁━━━━━○●",text1)
...
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1174250096) then  
...
send(msg.chat_id_, msg.id_, t..'●○━━━━━𝑄𝑁━━━━━○●\nاضغط علي الاسم ليتم نسخه\n●○━━━━━𝑄𝑁━━━━━○●\n')
end
--__
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '- - Source Queen . .',url="t.me/Source_Queen"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
{
{text = '- Source Queen .', url = "https://t.me/Source_Queen"}
},
{
{text = 'اضف البوت لمجموعتك🌖', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
