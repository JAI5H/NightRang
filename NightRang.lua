...
if text == 'سورس جولد' or text == 'جولد' or text == 'تيست الكودد' then
local Text = [[
test
]]
keyboard = {} 
...
local TEXT_SUD = database:get(bot_id..'NightRang:TEXT_SUDO')
if TEXT_SUDO then 
...
if text == 'رامي' or text == 'تايجر' or text == 'تايجر التلي' or text == 'تيجر' or text == 'قلب تتتلعالمي' then
local Text =[[
مطور السورس ✅
]]
keyboard = {} 
