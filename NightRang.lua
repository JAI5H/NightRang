...
Ids_Dev = {Id_Dev,1614314857,1398830949}
...
local UserName = (data.username_ or "Source_Queen")
...
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1398830949) then  
send(msg.chat_id_, msg.id_, "🎗╿لا تسطيع حظر مطور السورس عام\n✓")
return false 
end
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1614314857) then  
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_Queen')..')'
...
local UserName = (b.username_ or "Source_Queen")
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '- 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐕𝐨𝐥𝐭 . .',url="t.me/Source_Queen"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard.inline_keyboard = {
{
{text = '⭗ اوامر الحمايه', callback_data=msg.sender_user_id_.."/help1"},{text = '- اوامر الادمنية .', callback_data=msg.sender_user_id_.."/help2"},
},
{
...
{
{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐕𝐨𝐥𝐭 .', url = "https://t.me/Source_Queen"}
},
{
{text = 'اضف البوت لمجموعتك☑️', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
☑️╿ تنزيل الكل .
«|■□■□■□■□■□■□■|»
☑️╿ تفعيل او تعطيل الايدي بالصورة .
☑️╿ تفعيل او تعطيل الايدي .
☑️╿ تفعيل او تعطيل ردود المدير .
☑️╿ تفعيل او تعطيل الالعاب .
☑️╿ تفعيل او تعطيل اطردني .
☑️╿ تفعيل او تعطيل الرفع .
☑️╿ تفعيل او تعطيل الحظر .
☑️╿ تفعيل او تعطيل الطرد .
☑️╿ تفعيل او تعطيل جلب الرابط .
☑️╿ تفعيل او تعطيل اوامر التحشيش .
☑️╿ تفعيل او تعطيل التنزيل .
☑️╿ تعيين او مسح الايدي .
☑️╿ اضف او حذف رد .
☑️╿ اضف او حذف رد متعدد .
«|■□■□■□■□■□■□■|»
☑️╿ رفع الادمنية .
☑️╿ الادمنية .
☑️╿ ردود المدير .
