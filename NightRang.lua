...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '- •🅲︎🅷︎🅰︎🅽︎🅽︎🅴︎🅻︎• .',url="t.me/AKJA0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if not redis:get(NightRang..'Abs:Lock:Games'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '⌁︙عذرا الالعاب معطله في المجموعه', 1, 'md')
end
end
