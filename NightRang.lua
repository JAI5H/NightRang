...
Ids_Dev = {Id_Dev,1756511631,1398830949,1398830949,}
User_Bot = sudos.User_bot
Name_Bot = (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "كوين")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
Status = true  
elseif tonumber(user_id) == tonumber(1174250096)1398830949atus = true    
...
Status = "انا البوت :) "
elseif tonumber(user_id) == tonumber(1174250096)1398830949atus = "〈 مبرمج السورس 〉."
elseif tonumber(user_id) == tonumber(1756511631) then  
Status = "〈 حبيب الكل 〉."
elseif Dev_Bots_User(user_id) == true then
Status = "〈 المطور الاساسي 〉."  
elseif redis:sismember(bot_id.."NightRang:Developer:Bot1", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "〈 المطور اساسي 〉."  
elseif redis:sismember(bot_id.."NightRang:Developer:Bot", user_id) then
...
local Text_keyboard = '-  𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒒𝒖𝒆𝒆𝒏 المطور الاساسي \n سورس كوين \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/AKJA0) '
local List_keyboard = {
{'تغيير اسم البوت'},
{'الاحصائيات'},
...
CmdStart = '\n🎗╿ اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "كوين")..''..
...
os.execute('wget https://raw.githubusercontent.com/amrjava/NightRang/main/NightRang.lua')
...
local list = redis:smembers(bot_id.."NightRang:Removal:User:Groups"..msg.chat_id_)
if #list == 0 then
...
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1174250096)1398830949nd(msg.chat_id_, msg.id_, "🎗╿لا تسطيع حظر مطور السورس عام\n✓")
return false 
end
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1756511631) then  
send(msg.chat_id_, msg.id_, "🎗╿لا تسطيع حظر 〈 حبيب الكل 〉\n✓")
return false 
end
...
if tonumber(result.id_) == tonumber(1174250096)1398830949nd(msg.chat_id_, msg.id_, "🎗╿لا تسطيع حظر مبرمج السورس عام\n✓")
return false 
end
if tonumber(result.id_) == tonumber(1756511631) then  
send(msg.chat_id_, msg.id_, "🎗╿لا تسطيع حظر 〈 حبيب الكل 〉\n✓")
return false 
end
...
if tonumber(userid) == tonumber(1174250096)1398830949nd(msg.chat_id_, msg.id_, "🎗╿لا تسطيع حظر مبرمج السورس عام\n✓")
return false 
end
...
redis:sadd(bot_id.."NightRang:Removal:User:Groups", userid)
...
redis:srem(bot_id.."NightRang:Removal:User:Groups", userid)
...
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1174250096)1398830949nd(msg.chat_id_, msg.id_, "🎗╿لا تسطيع كتم مطور السورس عام\n✓")
return false 
end
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1756511631) then  
send(msg.chat_id_, msg.id_, "🎗╿لا تسطيع كتم 〈 حبيب الكل 〉\n✓")
return false 
end
if DeveloperBot112(result.id_) == true then
send(msg.chat_id_, msg.id_, "لا تستطيع كتم المطور عام\n✓")
...
redis:sadd(bot_id.."NightRang:Developer:Bot", userid)
...
redis:srem(bot_id.."NightRang:Developer:Bot", userid)
...
if text == 'سورس كوين' or text == 'حرنكش' or text == 'تيست الكودد' then
local Text = [[
test
]]
keyboard = {} 
...
if text == ("رفع كوين") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Bots(msg) then
function FunctionStatus(arg, result)
...
if text == ("تنزيل كوين") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Bots(msg) then
function FunctionStatus(arg, result)
redis:srem(bot_id.."NightRang:Developer:Bot1", result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","تم تنزيله من مطور ثانوي")  
end
...
if text and text:match("^رفع كوين @(.*)$") and Dev_Bots(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"عذرا هاذا معرف قناة")   
...
if text and text:match("^تنزيل كوين @(.*)$") and Dev_Bots(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
...
if text == 'المطور' or text == 'مطور' or text == 'مطور بوت' then
local Text = [[
المطور -  ]].. UserName_Dev..[[
]]
keyboard = {} 
...
if text == 'عالمي' or text == 'العالمي الهكر' or text == 'فلسطس' or text == 'فلسطس الهكر' or text == 'العالمي' then
local Text =[[
🎗╿ مطور السورس  .
...
{
{text = 'العالمي🇨🇰', url = "https://t.me/UU_Fs"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/j3333x&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'جوست' or text == 'جوست' or text == 'مروان' or text == 'توام العالمي' or text == 'روح العالمي' then
local Text =[[
🎗╿ مطور السورس  .
🎗╿ يمكنك التواصل معه عن طريق معرفه .
...
...
{
{text = 'جوست🇨🇰', url = "https://t.me/UU_Dev"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G500t&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'ماجد' or text == 'ماقد' or text == 'ماقد' or text == 'مياتي' or text == 'قلب العالمي' then
local Text =[[
🎗╿ مطور السورس  .
🎗╿ يمكنك التواصل معه عن طريق معرفه .
...
...
{
{text = 'ماجد🇨🇰', url = "https://t.me/M_22_8"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/M_22_8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local UserName = (b.username_ or "AKJA0")
...
فكر قبل لا تتسرع وتروح يا حرنكش 🌖 🐾
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '- بوت حذف 🎗╿', url = "https://t.me/LC6BOT"}
},
{
{text = 'اضف البوت لمجموعتك🌖', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
if text == (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "كوين") then
Namebot = (redis:get(bot_id.."NightRang:Redis:Name:Bot") or "كوين")
local namebot = {
"يا روح "..Namebot.. " قول",
...
https.request('http://devstorm.ml/tshake/tahaj200.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '- - Source Queen . .',url="t.me/AKJA0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'العاب كوين' or text == 'الالعاب كوين' or text == 'العاب متطوره' then  
local Text = [[  
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/FsFs0100&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'الالعاب' or text == 'الالعاب' or text == 'الالعاب كوين' or text == '"' then
local Text =[[
للالعاب الاحترافيه
اكتب ← الالعاب كوين
«|■□■□■□■□■□■□■|»
...
🎗╿  لعبة ترتيب ← ترتيب .
🎗╿ لعبة سمايلات ← سمايلات .
🎗╿ لعبة حزوره  ← حزوره .
🎗╿ لعبة المعاني ← المعاني .
🎗╿ لعبه العكس ← العكس .
...
«|■□■□■□■□■□■□■|»
➳ [sᴏᴜʀᴄᴇ ᴠᴏʟᴛ](https://t.me/AKJA0)🎗╿
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '🎗╿ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌', url = "https://t.me/AKJA0"},
},
{
{text = 'اضف البوت لمجموعتك🌖', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
if text == 'يا بوت' or text == 'بوت' or text == 'بوت كوين' then
local Text = [[
اسمي  ]].. Name_Bot..[[ يعمري 🥺💛
]]
keyboard = {} 
...
local UserName = (b.username_ or "SRC-NightRang")
...
if text == 'الاوامر' or text == 'الاوامر كوين' or text == 'الأوامر' then
if Admin(msg) then
local Text =[[
* اهلا بك في قسم الاوامر *
«|■□■□■□■□■□■□■|»
🎗╿ اليك الاوامر الخاص بسورس كوين .
...
{
{text = '- Source Queen .', url = "https://t.me/AKJA0"}
},
{
{text = 'اضف البوت لمجموعتك🌖', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
if text and text:match("^ايدي @(.*)$") and not redis:get(bot_id..'NightRang:Lock:Id:Photo'..msg.chat_id_) or text and text:match("^ايدي @(.*)$") and not redis:get(bot_id..'NightRang:Lock:Id:Photo'..msg.chat_id_) then
...
local Texti = 'اضغط ع تفعيل حرنكش لتشغل البوت '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'تفعيل حرنكش', callback_data="/addchat@"..msg.sender_user_id_},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Texti).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
