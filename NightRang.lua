...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'CHANNELt.',url="t.me/AKJA0"}}, 
{{text = 'DEV.',url="t.me/USER_GOLD"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/USER_ALFA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--- كليشه سورس ---
